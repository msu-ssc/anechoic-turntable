...
_ERROR_PATTERN = re.compile(rb"MSG:ERR:(?P<reason>POSITION_DISCONTINUITY|MOVEMENT_TIMEOUT|MOVEMENT_STALLED);\r\n\Z")
_UINT32_MAX = 2**32 - 1
...
class ReceivedMessageError(ReceivedMessage):
    ...
    reason: Literal["POSITION_DISCONTINUITY", "MOVEMENT_TIMEOUT", "MOVEMENT_STALLED"]
